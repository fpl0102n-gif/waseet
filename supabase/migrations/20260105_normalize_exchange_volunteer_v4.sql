-- Migration: Normalize Exchange & Volunteers (V4 - Fix Transport Policy Dependency)
...
DROP POLICY IF EXISTS "Public volunteers are visible" ON public.transport_volunteers; -- THE FIX
