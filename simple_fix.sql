-- SIMPLE FIX: Handling Localhost HTTP and Standard Syntax
-- This version simplifies the logic to avoid syntax errors.
...
BEGIN
  ...
  -- 2. Construct URL (Force HTTP for localhost to avoid SSL error)
  ...
  VALUES ('Trigger V5 (Simple)', jsonb_build_object('type', TG_ARGV[0], 'url', final_url, 'id', NEW.id));
